...
!
! Each input line is  pdry[bar]  fco2  tg0[K]  zenith[deg]  surfalb
! and produces one output line  pdry fco2 tg0 zy surfalb OLR PALB
...
real :: pdry, fco2, tg0, zy, surfalb, olr, palb
integer :: ios
...
do
  read(*,*,iostat=ios) pdry, fco2, tg0, zy, surfalb
  if ( ios .ne. 0 ) exit
  call getOLR(  pdry, fco2, tg0, olr )
  call getPALB( pdry, fco2, tg0, zy, surfalb, palb )
  write(*,'(7ES20.10)') pdry, fco2, tg0, zy, surfalb, olr/1000., palb
end do
